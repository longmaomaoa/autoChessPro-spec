...
setattr(sys.modules['PyQt6.QtWidgets'], 'QMainWindow', MockQWidget)
setattr(sys.modules['PyQt6.QtWidgets'], 'QMenuBar', MockQWidget)
setattr(sys.modules['PyQt6.QtWidgets'], 'QMenu', MockQWidget)
setattr(sys.modules['PyQt6.QtWidgets'], 'QStatusBar', MockQWidget)
setattr(sys.modules['PyQt6.QtWidgets'], 'QToolBar', MockQWidget)
setattr(sys.modules['PyQt6.QtWidgets'], 'QMessageBox', MockQWidget)
setattr(sys.modules['PyQt6.QtWidgets'], 'QFileDialog', MockQWidget)
setattr(sys.modules['PyQt6.QtWidgets'], 'QDialog', MockQWidget)
